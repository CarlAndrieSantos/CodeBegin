...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (isset($_SESSION['id'])) {
        ...
        if ($stmt = mysqli_prepare($connection, $query)) {
            // Bind parameters
            mysqli_stmt_bind_param($stmt, "isssssssisss", $user_id, $first_name, $last_name, $phone, $user_address, $age, $gender, $prepared_time, $course_id, $tutor_id, $available_date, $payment_method);
        ...
        <div class="container_booking">
            ...
            <div class="info">
               <label for="phone">Phone Number:</label>
                <input type="text" name="user_phone" placeholder="Enter your phone number" required><br><br>
